...
function exibirResultado(torneira) {
    const descricoes = {
        ...
        'Torneira de Cozinha Gourmet com Ducha Retrátil': 'Você é uma torneira altamente funcional e focada em facilitar a vida dos usários. Essa torneira combina a sua praticidade e sofisticação.',
